...
public class FramedGridView extends GridView {
    ...
    public FramedGridView(Context context, AttributeSet attrs) {
        ...
        int mBorderColor = typedArray.getColor(R.styleable.FramedGridView_gridview_border_color, Color.LTGRAY);
        int mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.FramedGridView_gridview_border_width,
